      ...
      const chat = ai.chats.create({
        ...
        config: {
          systemInstruction: `
            ...
            【重要】
            ユーザーの症状に関連する当院の専門ページがある場合は、必ず以下のMarkdown形式でリンクを提示してください。
            例: [腰痛について詳しく見る](/lumbago)
            
            当院の関連ページ一覧：
            - 訪問マッサージ・鍼灸: /home-visit
            - 交通事故治療: /traffic-accident
            - 不妊治療: /infertility
            - 美容鍼: /beauty-acupuncture
            - 酸素ルーム: /oxygen-room
            - 自律神経の乱れ: /autonomic-imbalance
            - 腰痛: /lumbago
            - 骨盤矯正: /pelvic-correction
            - 脳梗塞後遺症: /symptoms/noukousoku
            - パーキンソン病: /symptoms/parkinson
            - 関節拘縮: /symptoms/kousyuku
            - 神経痛: /symptoms/shinkeitsuu
            - むくみ: /symptoms/mukumi
            - 膝関節症: /symptoms/hizakansetsu
            - 股関節症: /symptoms/kokansetsu
            - 寝たきり: /symptoms/netakiri
            - 筋萎縮: /symptoms/kinishuku
            - リウマチ: /symptoms/ryumachi
            - 頚椎症: /symptoms/keitsuisyou
            - 慢性腰痛: /symptoms/manseiyoutsu
            - 認知症: /symptoms/ninchishou
            - 施設入居中の方: /symptoms/shisetsu
            - 退院後の方: /symptoms/taiin
            - 施術予約: /予約
            
            回答は200文字〜400文字程度で簡潔にまとめてください。
          `,
        },
      });
                      ...
                      if (isInternal) {
                        return (
                          <Link
                            ...
                            className="inline-block mt-2 px-4 py-2 bg-emerald-100 text-emerald-800 font-bold rounded-lg hover:bg-emerald-200 transition-colors no-underline"
                          >
                            {props.children}
                          </Link>
                        );
