...
export const DaitoReservationPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="min-h-screen bg-stone-50 pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-3xl">
        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-stone-100 text-center">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg md:text-xl">大塔院の予約システムを開く</span>
            </div>
        ...
        <div className="mt-12 text-center">
          <Link to="/施術予約" className="text-stone-500 hover:text-blue-600 font-medium transition-colors">
            ← 院選択へ戻る
          </Link>
        </div>
      </div>
