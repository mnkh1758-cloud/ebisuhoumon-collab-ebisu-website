...
const SLIDES = [
  {
    id: 1,
    image: "https://github.com/ebisuhoumon-collab/ebisuhoumon-collab-ebisu-website/blob/main/roujin.jpg.webp?raw=true",
    alt: "Healthy Lifestyle and Wellness"
  },
  {
    id: 2,
    image: "https://github.com/ebisuhoumon-collab/ebisuhoumon-collab-ebisu-website/blob/main/harikyusenaka.jpg.webp?raw=true",
    alt: "Acupuncture and Osteopathy Treatment"
  },
  {
    id: 3,
    image: "https://github.com/ebisuhoumon-collab/ebisuhoumon-collab-ebisu-website/blob/main/massajiotoko.jpg.webp?raw=true",
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 pt-12">
          ...
          <div className="max-w-3xl space-y-8 animate-fade-in-up lg:w-1/2">
            ...
            <div className="pt-6 flex flex-col sm:flex-row gap-5">
              ...
              <Link
                to="/home-visit"
                className="group px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 font-bold rounded-full transition-all text-center hover:border-white/50 shadow-lg flex items-center justify-center"
              >
                <span className="tracking-wide">訪問鍼灸について</span>
              </Link>
            </div>
          </div>
