...
export const KokansetsuPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    
    // SEO Settings
    document.title = "変形性股関節症でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "佐世保市で変形性股関節症による足の付け根の痛みや歩行困難にお悩みならえびす鍼灸整骨院の訪問マッサージへ。医療保険適用でご自宅・施設へ伺い、痛み・可動域・歩行の改善を目指します。");
    }
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【変形性股関節症】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">変形性股関節症は、</p>
              <ul className="grid sm:grid-cols-2 gap-3 mb-6">
                {['歩くと股関節が痛む', '立ち上がりがつらい', '足の付け根がズキッと痛む', '歩幅が小さくなる', '股関節が固くて動かしにくい', '長時間の歩行ができない', '通院が難しい'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                など、日常生活に大きな負担を与える症状です。<br/>
                当院では、国家資格者がご自宅で<br/>
                <span className="font-bold text-orange-600">股関節の痛み・可動域・歩行の改善</span> を目的とした施術を行います。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 max-w-4xl space-y-24">
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">股関節の軟骨がすり減り、炎症や変形が進むことで痛みが出ます。</p>
          </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">変形性股関節症に対して、当院では以下の施術を組み合わせて行います。</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>股関節周囲の痛みを軽減</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>炎症の緩和</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>歩行時の負担を軽減</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>股関節周囲の筋膜の癒着を改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>むくみの軽減</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>股関節の動きをスムーズに</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>股関節周囲の筋緊張を緩和</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>動作時の痛みを軽減</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>股関節の可動域改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>臀部・大腿部の筋力強化</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>立ち上がり・歩行訓練</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>再発予防のための運動指導</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>慢性痛の改善補助</li>
              </ul>
              <p className="text-xs text-stone-500 mt-2">※訪問施術と併用することで回復をサポート</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>不安の軽減</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>生活意欲の向上</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center bg-white p-6 rounded-2xl border border-orange-200 shadow-sm">
              <p className="text-stone-800 font-bold text-lg leading-relaxed">
                「完全に治す」のではなく、<br />
                <span className="text-orange-600 text-xl">“痛みを減らし、動ける範囲を広げる”</span><br />
                ことを目的としたケアです。
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: '変形性股関節症でも保険は使えますか？', a: 'はい。医師の同意書があれば1〜3割負担で利用できます。' },
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              変形性股関節症のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
