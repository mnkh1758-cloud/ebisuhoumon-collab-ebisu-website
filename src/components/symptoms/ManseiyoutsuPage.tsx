...
export const ManseiyoutsuPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "慢性腰痛でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【慢性腰痛】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">慢性腰痛（脊柱管狭窄症・腰椎椎間板ヘルニアなど）による</p>
              <ul className="grid grid-cols-2 gap-3 mb-6">
                {['常に腰が重だるい・痛い', 'お尻から足にかけてしびれる', '少し歩くと足が痛くて休んでしまう', '朝起き上がるのが辛い', '寝返りを打つと痛む', '痛くて外出がおっくう'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                ...
                <span className="font-bold text-orange-600">「痛みやしびれを和らげ、歩行や日常動作を楽にする」</span> ためのサポートを行います。
              </p>
            </div>
          </div>
        </div>
        ...
        <section>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-stone-100">
            <div className="grid md:grid-cols-2 gap-6">
              {[
                '長年腰痛に悩まされており、治らないと諦めている',
                '足のしびれがひどく、長く歩けない（間欠性跛行）',
                '腰が曲がってきて、姿勢が悪くなった',
                '痛み止めや湿布が手放せない',
                '痛みをかばって膝や股関節も痛くなってきた',
                '通院したくても痛くて歩くのが辛い'
              ].map((item, i) => (
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>腰周りの深部の筋肉の緊張を解く</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>腰から足にかけての神経痛に直接アプローチ</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>腰・お尻・足の筋肉の緊張をほぐす</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>腰に負担のかからない姿勢の指導</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>体幹（コア）の筋力強化・ストレッチ</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>正しい歩き方の指導</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              慢性腰痛のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
