...
export const HizakansetsuPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    
    // SEO Settings
    document.title = "変形性膝関節症でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "佐世保市で変形性膝関節症による膝の痛みや歩行困難にお悩みならえびす鍼灸整骨院の訪問マッサージへ。医療保険適用でご自宅・施設へ伺い、痛み・可動域・歩行の改善を目指します。");
    }
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【変形性膝関節症】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">変形性膝関節症は、</p>
              <ul className="grid sm:grid-cols-2 gap-3 mb-6">
                {['歩くと膝が痛い', '立ち上がりがつらい', '階段の昇り降りができない', '膝が腫れて動かしにくい', 'O脚が進行してきた', '病院に通うのが難しい'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                ...
                当院では、国家資格者がご自宅で<br/>
                <span className="font-bold text-orange-600">膝の痛み・可動域・歩行の改善</span> を目的とした施術を行います。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 max-w-4xl space-y-24">
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">膝の軟骨がすり減り、炎症や変形が進むことで痛みが出ます。</p>
          </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">変形性膝関節症に対して、当院では以下の施術を組み合わせて行います。</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>膝周囲の痛みを軽減</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>膝周囲の筋膜の癒着を改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>むくみの軽減</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>膝の動きをスムーズに</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>膝周囲の筋緊張を緩和</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>動作時の痛みを軽減</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>膝の可動域改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>大腿四頭筋の筋力強化</li>
        ...
        <section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: '変形性膝関節症でも保険は使えますか？', a: 'はい。医師の同意書があれば1〜3割負担で利用できます。' },
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              変形性膝関節症のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
