...
export const KinishukuPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    
    // SEO Settings
    document.title = "筋萎縮でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "佐世保市で筋萎縮（筋肉の衰え）にお悩みならえびす鍼灸整骨院の訪問マッサージへ。医療保険適用でご自宅・施設へ伺い、リハビリやマッサージで筋力維持・向上をサポートします。");
    }
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【筋萎縮】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">筋萎縮（筋肉の衰え）は、</p>
              <ul className="grid sm:grid-cols-2 gap-3 mb-6">
                {['手足が細くなってきた', '立ち上がりや歩行が困難', '少し動いただけで疲れる', '関節が固まってきた', '転倒しやすくなった', '寝たきりになるのが不安'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                など、日常生活に大きな影響を与える症状です。<br/>
                当院では、国家資格者がご自宅で症状に合わせた施術を行い、<br/>
                <span className="font-bold text-orange-600">筋力の維持・向上と、日常生活動作の改善</span> を目指します。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 max-w-4xl space-y-24">
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">筋萎縮は、病気や加齢、長期間の安静などによって筋肉が痩せ細り、筋力が低下する状態です。</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-stone-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                '病気や加齢、ケガなどで筋肉が痩せてしまった',
                '少し動いただけでひどく疲れる',
                'ペットボトルを開けるなどの日常動作が難しい',
                '歩くスピードが遅くなり、すり足になっている',
                'これ以上筋力が落ちて寝たきりになるのが不安',
                'リハビリに通いたいが、移動手段がない'
              ].map((item, i) => (
            ...
            <div className="mt-8 p-4 bg-orange-50 rounded-xl border border-orange-100 text-center">
              <p className="text-orange-800 font-bold">
                筋萎縮は放置すると関節拘縮や寝たきりにつながるため、継続的なケアが重要です。
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">筋萎縮に対して、当院では以下の施術を組み合わせて行います。</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>残存機能（今ある筋力）の維持・強化</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>関節可動域訓練による拘縮予防</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流を改善し、筋肉への栄養供給を促す</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋肉の緊張を和らげ、動きやすくする</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>むくみや冷えの改善</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-lg text-stone-800">電気刺激療法（EMS等）</h3>
              </div>
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>動かしにくい筋肉に電気刺激を与え収縮を促す</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋萎縮の進行予防</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>神経の働きを活性化させる</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>全身のバランスを整え、自然治癒力を高める</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋膜の癒着を改善し、筋肉の動きをスムーズに</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流・リンパの流れを促進</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>リハビリへの意欲向上をサポート</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>不安の軽減と精神的なケア</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-50/50 rounded-3xl p-8 md:p-12 border border-orange-100">
          ...
          <div className="max-w-2xl mx-auto">
            <ul className="grid sm:grid-cols-2 gap-4 mb-8">
              {[
                '筋力の維持・向上により、できる動作が増える',
                '関節が柔らかくなり、動きがスムーズになる',
                '血流が良くなり、手足の冷えやむくみが改善される',
                '転倒リスクが軽減し、安全に生活できるようになる',
                '疲れにくくなり、活動範囲が広がる',
                '寝たきりになるのを予防できる'
              ].map((item, i) => (
            ...
            <div className="text-center bg-white p-6 rounded-2xl border border-orange-200 shadow-sm">
              <p className="text-stone-800 font-bold text-lg leading-relaxed">
                「完全に元通りにする」のではなく、<br />
                <span className="text-orange-600 text-xl">“今ある機能を最大限に活かし、生活の質を高める”</span><br />
                ことを目的としたケアです。
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: '筋萎縮でも保険は使えますか？', a: 'はい。医師の同意書があれば1〜3割負担で利用できます。' },
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              筋萎縮のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
