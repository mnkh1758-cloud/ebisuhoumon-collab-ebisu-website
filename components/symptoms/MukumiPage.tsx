...
export const MukumiPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    
    // SEO Settings
    document.title = "むくみ（浮腫）でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "佐世保市で足のむくみ（浮腫）や重だるさにお悩みならえびす鍼灸整骨院の訪問マッサージへ。医療保険適用でご自宅・施設へ伺い、マッサージやメディセルでリンパ循環を改善します。");
    }
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【むくみ（浮腫）】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">むくみ（浮腫）は、</p>
              <ul className="grid sm:grid-cols-2 gap-3 mb-6">
                {['足がパンパンに張る', '靴下の跡がくっきり残る', '夕方になると足が重だるい', '長時間座っていると悪化する', '心臓・腎臓・リンパの問題でむくみやすい', '寝たきりで足が腫れやすい'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                など、生活の質を大きく下げる症状です。<br/>
                当院では、国家資格者がご自宅でむくみの原因に合わせた施術を行い、<br/>
                <span className="font-bold text-orange-600">血流改善・リンパ循環改善・痛みや重だるさの軽減</span> を目指します。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 max-w-4xl space-y-24">
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">むくみは、血液やリンパ液の流れが悪くなることで起こります。</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-stone-100">
            ...
            <div className="mt-8 p-4 bg-orange-50 rounded-xl border border-orange-100 text-center">
              <p className="text-orange-800 font-bold">
                むくみは放置すると悪化しやすく、皮膚トラブルや感染症のリスクも高まります。
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">むくみに対して、当院では以下の施術を組み合わせて行います。</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>むくみの原因となる筋緊張の緩和</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流促進</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>リンパ循環の改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>むくみの軽減</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋膜の癒着を改善し、足の重だるさを緩和</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>慢性的なむくみの軽減</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>足の重だるさの軽減</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>足首・膝の可動域改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋力低下予防</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>歩行の安定性向上</li>
              </ul>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center bg-white p-6 rounded-2xl border border-orange-200 shadow-sm">
              <p className="text-stone-800 font-bold text-lg leading-relaxed">
                「完全に治す」のではなく、<br />
                <span className="text-orange-600 text-xl">“むくみを減らし、生活を楽にする”</span><br />
                ことを目的としたケアです。
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: 'むくみでも保険は使えますか？', a: 'はい。医師の同意書があれば1〜3割負担で利用できます。' },
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              むくみ（浮腫）のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
