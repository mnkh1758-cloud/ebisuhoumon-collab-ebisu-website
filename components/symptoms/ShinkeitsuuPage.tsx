...
export const ShinkeitsuuPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    
    // SEO Settings
    document.title = "神経痛でお困りの方へ｜佐世保市の訪問鍼灸マッサージ";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "佐世保市で坐骨神経痛や帯状疱疹後神経痛などにお悩みならえびす鍼灸整骨院の訪問マッサージへ。医療保険適用でご自宅・施設へ伺い、鍼灸治療やハイボルト治療で痛みを緩和します。");
    }
  }, []);
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-serif text-stone-800 mb-8 leading-tight">
              【神経痛】で<br className="md:hidden" />お困りの方へ
            </h1>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100 text-left max-w-2xl mx-auto">
              <p className="text-stone-700 mb-4 font-bold">神経痛は、</p>
              <ul className="grid sm:grid-cols-2 gap-3 mb-6">
                {['坐骨神経痛', '帯状疱疹後神経痛', '頚椎症・腰椎症による神経痛', '手足のしびれ', '動作時の鋭い痛み', '慢性的な痛み'].map((item, i) => (
              ...
              <p className="text-stone-700 text-sm md:text-base leading-relaxed">
                ...
                <span className="font-bold text-orange-600">痛みの軽減・しびれの緩和・動作の改善</span> を目指します。
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 max-w-4xl space-y-24">
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">神経痛は、神経が圧迫されたり炎症を起こすことで発生します。</p>
          </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="text-stone-600">神経痛に対して、当院では以下の施術を組み合わせて行います。</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>神経痛の痛みを緩和</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>深部の神経痛にアプローチ</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>炎症の軽減</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>神経の通り道を整える</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                ...
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>神経周囲の炎症軽減</li>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>血流改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>筋緊張の緩和</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>痛みの軽減</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
              ...
              <ul className="space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>姿勢改善</li>
                <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-stone-300 rounded-full"></div>動作時の負担軽減</li>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center bg-white p-6 rounded-2xl border border-orange-200 shadow-sm">
              <p className="text-stone-800 font-bold text-lg leading-relaxed">
                「完全に治す」ではなく、<br />
                <span className="text-orange-600 text-xl">“痛みを減らし、生活を楽にする”</span><br />
                ことを目的としたケアです。
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[
              { q: '神経痛でも保険は使えますか？', a: 'はい。医師の同意書があれば1〜3割負担で利用できます。' },
        ...
        <section className="bg-orange-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6">
              神経痛のことでお困りの方は、<br className="hidden md:block" />
              まずはお気軽にご相談ください
            </h2>
